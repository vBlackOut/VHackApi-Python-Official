...
class Update:
	...
	def SpywareInfo(self):
		ut = Utils()
		arr = ut.requestArray("user::::pass::::uhash:::::", self.api.getUsername() + "::::" + self.api.getPassword() + "::::" + "UserHash_not_needed" + ":::::", "vh_spywareInfo.php")
		return arr

	def removeSpyware(self):
		ut = Utils()
		arr = ut.requestArray("user::::pass::::uhash:::::", self.api.getUsername() + "::::" + self.api.getPassword() + "::::" + "UserHash_not_needed" + ":::::", "vh_removeSpyware.php")
		return arr
